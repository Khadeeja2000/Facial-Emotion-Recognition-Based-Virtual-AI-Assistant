#!/usr/bin/env python3
"""
Live EfficientNetB0 Emotion Detection
====================================

Real-time emotion detection using EfficientNetB0 model.
...
class LiveEfficientNetB0System:
    """Live emotion detection with EfficientNetB0 and personalized recommendations."""
    
    def __init__(self):
        print("Loading Live EfficientNetB0 System")
        print("=" * 50)
        ...
        pygame.display.set_caption("Live EfficientNetB0 Emotion Detection")
        ...
        # Emotion labels (matching training script)
    ...
    def save_session_data(self):
        ...
        with open(f"{session_dir}/summary.txt", 'w') as f:
            f.write(f"EfficientNetB0 Live Session Summary\n")
    ...
    def generate_gradcam(self, frame):
        ...
        try:
            ...
            processed_frame = preprocess_image_for_model(frame, 'efficientnetb0')
            
            # Generate Grad-CAM heatmap
            heatmap = grad_cam(self.model, processed_frame, 'block6a_expand_conv')
        ...
        try:
            while running:
                ...
                if self.current_screen == 'monitoring':
                    ...
                    # Title
                    title_surface = self.fonts['title'].render("EfficientNetB0 Live Detection", True, self.colors['text'])
...
def main():
    """Main function."""
    system = LiveEfficientNetB0System()
