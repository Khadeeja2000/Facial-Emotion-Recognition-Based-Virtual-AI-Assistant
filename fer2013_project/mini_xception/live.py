#!/usr/bin/env python3
"""
Live Mini-XCEPTION Emotion Detection
===================================
...
class LiveMiniXceptionSystem:
    """Live emotion detection with Mini-XCEPTION and personalized recommendations."""
    
    def __init__(self):
        print("Loading Live Mini-XCEPTION System")
        print("=" * 50)
        ...
        pygame.display.set_caption("Live Mini-XCEPTION Emotion Detection")
        ...
        try:
            ...
            print("Mini-XCEPTION model loaded (59.9% accuracy)")
        except Exception as e:
            print(f"Error loading Mini-XCEPTION model: {e}")
            return
    ...
    def save_session_data(self):
        ...
        with open(f"{session_dir}/summary.txt", 'w') as f:
            f.write(f"Mini-XCEPTION Live Session Summary\n")
        ...
        try:
            while running:
                ...
                if self.current_screen == 'monitoring':
                    ...
                    # Title
                    title_surface = self.fonts['title'].render("Mini-XCEPTION Live Detection", True, self.colors['text'])
